...
Vec3f Vec3f::operator-(Vec3f& other) { return Vec3f(x = x - other.x, y = y - other.y, z = z -other.z); }
Vec3f Vec3f::operator-(float other) { return Vec3f(x = x - other, y = y - other, z = z - other); }
Vec3f operator-(float scalare, Vec3f& other) {return Vec3f(scalare - other.x, scalare - other.y, scalare -other.z);}
